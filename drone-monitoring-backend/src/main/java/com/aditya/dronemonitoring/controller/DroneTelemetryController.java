...
import com.aditya.dronemonitoring.service.TelemetryExportService;
...
public class DroneTelemetryController {
        ...
        public DroneTelemetryController(
        ...
        public ResponseEntity<Page<TelemetryResponseDTO>> getTelemetryHistory(
        ...
        @GetMapping("/export/{droneId}")
        public ResponseEntity<String> exportTelemetry(

                        @PathVariable Long droneId) {

                String csv = exportService.exportTelemetry(droneId);
                ...
                return ResponseEntity.ok()
                                ...
                                .header(
                                                ...
                                                "attachment; filename=drone_" + droneId + "_telemetry.csv"
